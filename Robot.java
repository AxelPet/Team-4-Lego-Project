...
// Imported these in order to play sounds:
import java.io.File;
...
public class Robot {
	...
	// Robots speed attributes:
	private int minSpeed = 50; // Minimum speed
	private int maxSpeed = 200; // Maximum speed
	
	// The robot is preferring right lane.
	
	// Wheel attributes:
	// (Measurements are represented in centimetres)
	...
	public boolean start() {
		...
		while (!Button.ESCAPE.isDown()) {
	        ...
	        if (this.usht.detectsObstacle()) {
                ...
                if (leftOfLine) {
                    // Robot was on the left of the line, move to the right to find the line again
